...
EXPERIENCES = [
    ("10_live_fruit_bowl_gpu.py", "Live GPU fruit bowl. Starts wireframe; press R for filled render."),
    ("11_live_capsule_walk.py", "Live capsule controller with third-person camera."),
